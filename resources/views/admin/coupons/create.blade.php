...
@section('content')
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col-sm mb-2 mb-sm-0">
                ...
                <h1 class="page-header-title">Add Coupons</h1>
    ...
    <form id="addCouponForm" class="row needs-validation" action="{{ route('admin.coupons.store') }}" method="POST">
        @csrf
        @method('POST')
        <div class="col-lg-8 mb-3 mb-lg-0">
            ...
            <div class="card mb-3 mb-lg-5">
                ...
                <div class="card-body">
                    <!-- Product name -->
                    <div class="mb-4">
                        <label for="productNameLabel" class="form-label required">Coupon Name</label>

                        <input type="text" class="form-control" name="coupon_name" id="nameInput"
                            placeholder="Enter coupon name..." required value="">
                        <div class="invalid-feedback"> Please enter coupon name.</div>
                    </div>

                    <!-- Post Slug -->
                    <div class="mb-4">
                        <label for="productSlugLabel" class="form-label required">Coupon code <i
                    ...
                    <!-- Release -->
                    <div class="mb-4">
                        <label for="couponRelease" class="form-label required">Coupon Release</label>
                        <input type="datetime-local" class="form-control" name="coupon_release" id="couponRelease" required value="{{ now()->toDateString() }}T{{ now()->toTimeString() }}">
                        <div class="invalid-feedback"> Please enter valid coupon release.</div>
                    </div>

                    <div class="mb-4">
                        <label for="couponExpired" class="form-label required">Coupon Expired</label>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-5">
                <!-- Header -->
                <div class="card-header">
                    <h4 class="card-header-title required">Coupon value</h4>
                </div>
                <!-- End Header -->
                ...
                <div class="card-body">
                    <!-- Post type -->
                    <div class="mb-4">
                        <label for="couponPrice" class="form-label">Coupon price <i
                                class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip" data-bs-placement="top"
                        ...
                        <input type="number" class="form-control" name="coupon_price" id="couponPrice" placeholder="0"
                            aria-label="0" required>
                        <div class="invalid-feedback"> Please enter coupon price.</div>
                    </div>
                    <div class="mb-4">
                        <label for="couponPerHundred" class="form-label">Coupon per_hundred <i
                                class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip" data-bs-placement="top"
                        ...
                        <input type="number" class="form-control" name="coupon_per_hundred" id="couponPerHundred"
                            placeholder="0" aria-label="0" required>
    ...
    <script>
        ...
        function handleSubmit(event) {
            ...
            let validRelease = checkInputDate(releaseDate);
            ...
            valid = validName && validRelease && validExpired && validPrice;
