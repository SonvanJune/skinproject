...
<header id="header" class="navbar navbar-expand-lg navbar-fixed navbar-height navbar-container navbar-bordered bg-white">
    <div class="navbar-nav-wrap">
      ...
      <div class="navbar-nav-wrap-content-start">
        ...
        <button type="button" id="header-toggler" class="navbar-aside-toggler" style="opacity: 1;">
          <i class="bi-arrow-bar-right navbar-toggler-short-align" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Expand"></i>
        </button>
              ...
              <div class="dropdown-menu dropdown-menu-end dropdown-card navbar-dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="navbarNotificationsDropdown" style="width: 25rem;">
                <div class="card">
                  ...
                  <ul class="nav nav-tabs nav-justified" id="notificationTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <a class="nav-link" href="#notificationNavTwo" id="notificationNavTwo-tab" data-bs-toggle="tab" data-bs-target="#notificationNavTwo" role="tab" aria-controls="notificationNavTwo" aria-selected="false" tabindex="-1">Archived</a>
                    </li>
                  </ul>
                  <!-- End Nav -->
                            ...
                            <div class="row">
                              <div class="col-auto">
                                <div class="d-flex align-items-center">
                                  ...
                                  <img class="avatar avatar-sm avatar-circle" src="{{asset('images/image-default.png')}}" alt="Image Description">
                                </div>
                              </div>
                              <!-- End Col -->
                              ...
                              <div class="col-auto">
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img" src="{{asset('images/image-default.png')}}" alt="Image Description">
                                  </div>
                                </div>
                              </div>
                              <!-- End Col -->
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                          <img class="avatar avatar-xs avatar-4x3" src="{{asset('images/image-default.png')}}" alt="Image Description">
                        </div>
          ...
          <li class="nav-item">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end navbar-dropdown-menu navbar-dropdown-menu-borderless navbar-dropdown-account" aria-labelledby="accountNavbarDropdown" style="width: 16rem;">
                ...
                <a class="dropdown-item" href="{{route('home')}}">Go to product page</a>
