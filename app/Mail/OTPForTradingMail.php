...
class OTPForTradingMail extends Mailable
{
    ...
    /**
     * Build the message contains the otp to complete the trading transaction
     *
    ...
    public function build()
    {
        return $this
            ->to($this->email)
            ->subject($this->app_name . " Trading Transaction")
            ->view('mail.trading');
    }
}
