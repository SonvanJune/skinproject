...
class OTPForRegistrationMail extends Mailable
{
    ...
    /**
     * Build the message contains the otp to active the account after registering
     *
    ...
    public function build()
    {
        return $this
            ->to($this->email)
            ->subject($this->app_name . " Active Account OTP")
