...
class ResetPasswordDTO
{
    ...
    public array $roles;
    public bool $did_reset_password;
    ...
    public function __construct(
        ...
        $this->roles = $roles;
        $this->did_reset_password = $did_reset_password;
    }
     ...
     */
    public static function fromModel(User $user, bool $did_reset_password): self
    {
        return new self(
