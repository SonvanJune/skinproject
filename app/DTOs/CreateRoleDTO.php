...
class CreateRoleDTO
{
    ...
    /**
     * Constructor to initialize the CreateRoleDTO object with role details.
    ...
    /**
     * Static method to create a CreateRoleDTO object from a Role model instance.
     * @param Role $role - The Role model object.
     * @return self|string - Returns a new CreateRoleDTO instance populated with role details.
     */
