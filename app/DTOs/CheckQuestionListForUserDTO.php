...
class CheckQuestionListForUserDTO
{
    // Properties representing the details of a user along with their assigned questions
     ...
     * @param bool $flag - A flag representing some additional information.
     */
    ...
    /**
     * Static method to create a CheckQuestionListForUserDTO instance from a User model.
     *
     * @param User $user - The User model instance to convert into a DTO.
     * @param bool $flag - A flag representing additional data.
     * @return self - Returns the created CheckQuestionListForUserDTO instance.
     */
    public static function fromModel(User $user, bool $flag): self
    {
        return new self(
            $user->user_id,
