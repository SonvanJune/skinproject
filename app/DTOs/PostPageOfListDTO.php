...
/**
 * Data Transfer Object (DTO) for representing a post in a list view.
 */
class PostPageOfListDTO
{
    /**
    ...
    /**
     * Create a new PostPageOfListDTO instance from an array of data.
     *
    ...
    /**
     * Create a PostPageOfListDTO instance from a Post model.
     *
     * @param Post $post The Post model instance.
     * @return self The PostPageOfListDTO instance.
     */
