...
class CreateCategoryDTO
{
    ...
    public int $status;
    public ?CreateCategoryDTO $parent;
    public int $type;
     ...
     * @param ?CreateCategoryDTO $parent The parent category as a DTO, if any.
    ...
    /**
     * Creates a CreateCategoryDTO instance from a Category model.
     *
    ...
    public static function fromModel(Category $category): self
    {
        ...
        return new self(
            ...
            $category->category_release ?
                (new DateTime($category->category_release))->format('Y-m-d H:i:s') :
