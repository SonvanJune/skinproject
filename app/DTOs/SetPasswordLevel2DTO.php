...
class SetPasswordLevel2DTO
{
    ...
    public array $roles;
    public bool $did_set_password_level_2;
    ...
    public function __construct(
        ...
        $this->roles = $roles;
        $this->did_set_password_level_2 = $did_set_password_level_2;
    }
     ...
     */
    public static function fromModel(User $user, bool $did_set_password_level_2): self
    {
        return new self(
            $user->user_id,
