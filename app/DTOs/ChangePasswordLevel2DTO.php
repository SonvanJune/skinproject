...
class ChangePasswordLevel2DTO
{
    ...
    public array $roles;
    public bool $did_change_password_level_2;
     ...
     * @param string $user_avatar The user's avatar.
    ...
    public function __construct(
        ...
        string $updated_at,
        array $roles,
        bool $did_change_password_level_2
    ) {
        ...
        $this->roles = $roles;
        $this->did_change_password_level_2 = $did_change_password_level_2;
    }

    /**
     * Create an DTO instance from a User model.
     *
     * @param User $user The User model instance.
     * @return self An instance of DTO.
     */
    public static function fromModel(User $user, bool $did_change_password_level_2): self
    {
        return new self(
            $user->user_id,
