...
class RegisterUserDTO
{
     ...
     * @param string $did_register A flag for register success.
    ...
    public function __construct(
        ...
        $this->did_register = $did_register;
        $this->role_list = $role_list;
    }

    /**
     * Creates a new RegisterUserDTO instance using the provided User model and did_register;.
     *
     ...
     * @param string $did_register; An authentication did_register; for the user.
     * @return self A new instance of the RegisterUserDTO populated with user data.
     */
    public static function fromModel(User $user, bool $did_register): self
    {
        return new self(
            $user->user_id,
